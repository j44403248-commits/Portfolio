...
const MyContact = () => {
  ...
  const contactInfo = [
    ...
    { icon: <MdOutlineAlternateEmail className="text-3xl text-[#38bdf8]" />, text: "jahanzaibmahar18@gmail.com", link: "mailto:jahanzaibmahar18@gmail.com" },
    { icon: <FaPhoneAlt className="text-3xl text-[#38bdf8]" />, text: "+92 3076341312", link: "tel:+923076341312" },
      { icon: <CgWebsite className="text-3xl text-[#38bdf8]" />, text: "jahanzaibmahar.com.app/", link: "https://jahanzaib-mahar-web.vercel.app/" },
  ];
            ...
            <div data-aos="fade-right" className="w-full lg:w-1/2 bg-gray-800 p-10 rounded-2xl shadow-2xl">
              ...
              <form ref={form} onSubmit={sendEmail} className="space-y-6">
                ...
                <div>
                  ...
                  <input type="tel" name="from_phone" required placeholder="+92 3076341312" className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#38bdf8] text-white" />
                </div>
                <div>
                  <label className="block text-gray-300 mb-2">Your Message</label>
                  <textarea name="message" rows="5" required placeholder="Hello Jahanzaib, I would like to discuss..." className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#38bdf8] text-white"></textarea>
                </div>
