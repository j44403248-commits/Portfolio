  ...
  const education = [
    {
      title: "Matriculation",
      period: "2019 - 2021",
      institution: "Usman Public High School (NWH)",
      icon: <FaGraduationCap className="text-white text-2xl" />,
    },
    {
      title: "Intermediate (ICS)",
      period: "2021 - 2023",
      institution: "Ali Pur College , Ali Pur",
      icon: <FaGraduationCap className="text-white text-2xl" />,
    },
  ];
                ...
                {education.map((item, index) => (
                  <div key={index} className="relative group">
                    ...
                    <div
                      ...
                      className="absolute -left-11 top-0 w-10 h-10 rounded-full bg-gradient-to-br from-[#38bdf8] to-[#0ea5e9] flex items-center justify-center text-white shadow-xl transition-transform duration-500 transform group-hover:scale-125 group-hover:rotate-0"
                    >
                      {item.icon}
                    </div>
