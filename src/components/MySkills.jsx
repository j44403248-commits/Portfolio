        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {skills.map((skill, index) => (
            <div
              ...
              key={index}
              className="relative bg-gray-800/60 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 h-64 flex flex-col justify-between trannsition-all duration-500 hover:shadow-xl hover:shadow-[#38bdf8]/30 hover:-translate-y-2"
            >
              {/* Icon */}
